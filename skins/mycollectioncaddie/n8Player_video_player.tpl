<script type="text/javascript">
    $(document).ready(function() {
        ...
        var autoPlayCookie = jrReadCookie('n8Player_video_autoplay');
        var volumeCookie = jrReadCookie('n8Player_audio_volume');
        var muteCookie = jrReadCookie('n8Player_auto_mute');
        ...
        $('#jp_container_{$uniqid}').bind($.jPlayer.event.volumechange, function(event){
            ...
            jrSetCookie('n8Player_audio_volume', jp_volume, 31);
        });

        $('#jp_container_{$uniqid} #jp-auto-play').click(function() {
            jrSetCookie('n8Player_video_autoplay', 0, 31);

            if ($(this).is(':checked')) {
                jrSetCookie('n8Player_video_autoplay', 1, 31);
            }
        });
        $('#jp_container_{$uniqid} #jp-auto-mute').click(function() {
            jrSetCookie('n8Player_auto_mute', 0, 31);
            if ($(this).is(':checked')) {
                jrSetCookie('n8Player_auto_mute', 1, 31);
            }
        });
    });
</script>

<div class="n8Player_player" onclick="event.cancelBubble = true; if(event.stopPropagation) event.stopPropagation();">
                ...
                <div class="jp-gui start">
                    ...
                    <div class="jp-interface">
                        <div class="jp-controls-holder">
                            ...
                            <ul class="jp-toggles">
                                <li><a class="jp-settings" tabindex="1"></a>
