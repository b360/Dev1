...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {mycollectioncaddie_breadcrumbs module="jrPage" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
...
<div class="box">
    {mycollectioncaddie_sort template="icons.tpl" nav_mode="jrPage" profile_url=$profile_url}
            ...
            {if $_post.module_url != 'page'}
                ...
                <div class="action_feedback">
                    ...
                    {if !isset($item.page_features) || $item.page_features == 'on'}
                        {mycollectioncaddie_feedback_buttons module="jrPage" item=$item}
