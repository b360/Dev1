...
<ul id="actions_tab">
    ...
    {elseif $nav_mode == 'about'}
        <li class="solo"><a href="#" title="{jrCore_lang skin="mycollectioncaddie" id="12" default="About"}">
    ...
    {elseif $nav_mode == 'online'}
        <li class="solo"><a href="#" title="{jrCore_lang skin="mycollectioncaddie" id="11" default="Online Status"}">
                {jrCore_icon icon="online" size="20" color="444444"}
            </a></li>
     {elseif $nav_mode == 'stats'}
        <li class="solo"><a href="#" title="{jrCore_lang skin="mycollectioncaddie" id="13" default="Stats"}">
                {jrCore_icon icon="stats" size="20" color="444444"}
            </a></li>
    ...
    {elseif $nav_mode == 'trending'}
        <li class="solo"><a href="#" title="{jrCore_lang skin="mycollectioncaddie" id="146" default="Trending"}">
