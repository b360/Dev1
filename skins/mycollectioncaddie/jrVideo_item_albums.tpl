{if !isset($_post._2)}
    ...
    <div class="page_nav clearfix">
        <div class="breadcrumbs">
            ...
            {mycollectioncaddie_breadcrumbs module="jrVideo" profile_url=$profile_url profile_name=$profile_name page="group"}
        </div>
...
{else}
    ...
    {literal}
        ...
        <div class="page_nav clearfix">
            <div class="breadcrumbs">
                {jrCore_include template="profile_header_minimal.tpl"}
                {mycollectioncaddie_breadcrumbs module="jrVideo" profile_url=$_items[0].profile_url page="group" item=$_items[0]}
            </div>
            <div class="action_buttons">
       ...
       <div class="col8">
           <div class="box">
               {mycollectioncaddie_sort template="icons.tpl" nav_mode="jrVideo" profile_url=$_items[0].profile_url}
                   ...
                   <div class="wrap detail_section">
                       ...
                       <div class="detail_box">
                           <div class="header">
                               ...
                               <div style="width:75%;">{jrCore_lang skin="mycollectioncaddie" id=42 default="Title"}</div>
                       ...
                       <div class="action_feedback">
                           {mycollectioncaddie_feedback_buttons module="jrVideo" item=$_items.0}
