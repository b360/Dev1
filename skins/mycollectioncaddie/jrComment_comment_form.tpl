            ...
            <div id="comment_form_section" style="display:table;width:100%">
                <div id="comment_area" style="display:table-row">
                    <script type="text/javascript">
                        ...
                        {
                            mycollectioncaddie_enter_listener();
                        });
                    </script>
                           ...
                           <div class="textArea">
                               <div>
                                   ...
                                   {if jrUser_is_logged_in()}
                                       ...
                                       {jrCore_lang skin="mycollectioncaddie" id=122 default="Write a comment ..." assign="ph"}
                               ...
                               <div id="comment_submit_section">
                                   <input type="submit" class="form_button form_button_disabled" value="{$sc|jrCore_entity_string}" id="comment_submit_button" disabled="disabled">
                               </div>
