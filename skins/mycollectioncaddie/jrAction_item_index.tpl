...
$(document).ready(function() {
    mycollectioncaddie_watch_timeline();
});
</script>
{/if}
        ...
        <div class="col8">
            <div class="breadcrumbs">
                ...
                {else}
                    {$apage = 'index'}
                {/if}
                {mycollectioncaddie_breadcrumbs module="jrAction" profile_url=$profile_url profile_name=$profile_name page=$apage}
        ...
        <div id="timeline">
            ...
            {if jrUser_is_linked_to_profile($_profile_id)}
                ...
                {if isset($_post.profile_actions) && $_post.profile_actions == 'mentions'}
                    ...
                    {/if}
                    {mycollectioncaddie_clear_notifications key='jrAction_mentions'}
                ...
                {elseif isset($_post.profile_actions) && $_post.profile_actions == 'feedback'}
                    ...
                    {mycollectioncaddie_clear_notifications key='jrComment_comments'}
                    {mycollectioncaddie_clear_notifications key='jrLike_likes'}
                    {mycollectioncaddie_clear_notifications key='jrLike_dislikes'}
                    {mycollectioncaddie_clear_notifications key='jrRating_ratings'}
