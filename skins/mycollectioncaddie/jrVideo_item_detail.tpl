...
<div class="page_nav clearfix">
    <div class="breadcrumbs">
        ...
        {mycollectioncaddie_breadcrumbs module="jrVideo" profile_url=$item.profile_url profile_name=$item.profile_name page="detail" item=$item}
    </div>
...
<div class="col8">
    <div class="box">
        {mycollectioncaddie_sort template="icons.tpl" nav_mode="jrVideo" profile_url=$profile_url}
        <div class="box_body">
            <div class="wrap detail_section">
                ...
                {elseif $item.video_file_extension == 'flv'}
                    {jrCore_media_player module="jrVideo" field="video_file" item=$item autoplay=$_conf.mycollectioncaddie_auto_play}
                {/if}
                ...
                <div class="action_feedback">
                    {mycollectioncaddie_feedback_buttons module="jrVideo" item=$item}
